...
final class ProgressView {
    ...
    private lazy var progressHud: NVActivityIndicatorView = {
        let indicatorView = NVActivityIndicatorView(frame: CGRect(x: UIScreen.main.bounds.midX-50, y: UIScreen.main.bounds.midY-50, width: 100, height: 100), type: .ballClipRotatePulse, color: .cyan, padding: .pi)
